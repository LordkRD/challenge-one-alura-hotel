...
public class RegistroHuesped extends JFrame {
	...
	public RegistroHuesped() {
		...
		lblTitulo.setBounds(606, 55, 247, 42);
		...
		//txtNreserva.setText("" + huespedController.getNreservas());
	...
	private void registrarHuesped(){		
		...
		String fechaNc = formato.format(txtFechaN.getDate());
		
		int idReserva = Integer.valueOf(txtNreserva.getText());
		
		String nacionalidad = (String) txtNacionalidad.getSelectedItem();
		
		var huespedes = new Huespedes(txtNombre.getText(), txtApellido.getText(), fechaNc, nacionalidad, 
				txtTelefono.getText(), idReserva);
		
		huespedController.guardar(huespedes);
		
		JOptionPane.showMessageDialog(this, "El numero de Reserva es " + idReserva);
